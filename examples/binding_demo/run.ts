/**
 * Launch A2A agent with programmatic module wrapping — zero code intrusion demo.
 *
 * Uses the apcore-js `module()` factory to wrap plain business functions as
 * A2A skills without modifying myapp.ts. This is the TypeScript equivalent of
...
// 3. Launch A2A agent with Explorer UI
serve(registry, {
  host: "127.0.0.1",
  port: 8000,
  explorer: true,
